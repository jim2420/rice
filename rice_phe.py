...
for i, year in enumerate(years):
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/india/ric_irr_fert/output/ric_irr_fert.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
plt.savefig('ricephe_avg_irr_india.jpg',dpi=300,bbox_inches='tight')
plt.show()
