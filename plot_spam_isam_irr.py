...
#isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/ric_irr_fert_long4/output/ric_irr_fert_long4.nc','r')
...
ric_i_f=isam.variables['totalyield'][103:105,:,:]
riceb=N.average(ric_i_f,axis=0)

ryield,lona11=shiftgrid(180.5,riceb,lonisam1,start=False)
...
plt.savefig('riceisam_spam_irr_new.jpg',bbox_inches='tight')
