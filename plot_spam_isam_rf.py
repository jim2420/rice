...
#isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/ric_fertall/output/ric_fertall.nc','r')
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/india/ric_fert/output/ric_fert.nc','r')
...
spamy = spam.variables['ricey_rainfed'][:,:]
spamya = spam.variables['riceya_rainfed'][:,:]
spamp = spam.variables['ricep_rainfed'][:,:]
spama = spam.variables['ricea_rainfed'][:,:]
...
plt.savefig('riceisam_spam_rf_new.jpg',bbox_inches='tight')
