...
region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/isamhiscru_rice_ch4aogs_luh2.nc','r')
#ch4 = N.average(region.variables['ch4'][96:103,:,:],axis=0)#year1997-2003
#mearea = N.average(region.variables['ricearea'][96:103,:,:],axis=0)#year1997-2003

ch4 = region.variables['ch4'][99,:,:]#year2000
mearea = region.variables['ricearea'][99,:,:]#year2000
...
#mearea= ma.masked_where(mearea<=0.0,mearea)
#mearea= ma.masked_where(mearea>=(10**20),mearea)
mearea[N.isnan(mearea)]=0.0
mearea[N.isinf(mearea)]=0.0
mearea= ma.masked_where(mearea<=0.0,mearea)
mearea=ma.filled(mearea, fill_value=0.)
...
faorate=[10.472,14,10.556,10.668,9.94,11.508,15.6058,21.1428,15.6498,33.4565,15.9936,17.6499,9.8251,17.8917]
num=14
...
isamgrid=allproisam*(10**9)/allgrid*10000
...
rects1 = plt.bar(index+0.1, allyisam, bar_width,
                 ...
                 color='blue',
                 label='ISAM')
rects2 = plt.bar(index +0.1+ bar_width*1,faorate , bar_width,
                 alpha=opacity,
                 color='r',
                 label='FAO')
...
plt.ylabel('EF (g CH4 / m2)',fontsize=35)
...
leg=plt.legend(loc=2,ncol=1, fontsize=35)
#leg.get_frame().set_alpha(0.5)
plt.tick_params(axis='both',labelsize=35)


plt.tight_layout()
plt.savefig('ric2000ch4rate_countluh2.png')
plt.show()
