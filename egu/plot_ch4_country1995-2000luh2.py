...
region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/isamhiscru_rice_ch4aogs_luh2flood2.nc','r')
...
plt.xticks(index + bar_width+0.30, ("Nepal","Pakistan","India","Sri Lanka","Bangladesh","Bhutan","Cambodia","Indonesia","Myanmar","Phillipines","Thailand","Vietnam","Laos","Malaysia"),rotation='vertical')
...
plt.tight_layout()
plt.savefig('ric19952000ch4_countluh2old.png')
plt.show()
