...
isam=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/egu_new/equilibrium_irr_fert/output/equilibrium_irr_fert.nc','r')
...
ax.plot_date(xx,base,"k-",label="Base")
ax.plot_date(xx,base_i,"r:",label="Irri")
ax.plot_date(xx,base_f,"b--",label="NFer")
ax.plot_date(xx,base_i_cli,"g-.",label="Irri X NFer")
...
plt.savefig('rice_effect_irr_fert.png')
plt.show()
