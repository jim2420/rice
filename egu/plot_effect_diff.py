...
yirr=(tbase-tbase_i+base-base_i)/(10**6)
...
yclinoi=(-tbase+tbase_i_cli-base+base_i_cli)/(10**6) #varclimate_I-varclimate_fixedI from conclimate

yf=(tbase-tbase_f+base-base_f)/(10**6)
ycli=(tbase-tbase_cli+base-base_cli)/(10**6)
yc=((tbase-tbase_c)-(base_c-base))/(10**6)
...
plt.ylabel('Effect on prodiction (t/yr)',fontsize=16)
...
plt.savefig('rice_effect_egu_diff.png')
plt.show()
