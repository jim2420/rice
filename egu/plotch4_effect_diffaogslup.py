...
yn=(tbase-tbase_n)/tbase*100
ylu=(tbase-tbase_lu)/tbase*100

tyirr=(base_i-base)/tbase*100
tyf=(base_f-base)/tbase*100
tycli=(base_cli-base)/tbase*100
tyc=(base_c-base)/tbase*100
tyn=(base_n-base)/tbase*100
tylu=(base-base_lu)/tbase*100
...
plt.ylabel('Effect on CH4 emissions (%)',fontsize=18)
...
plt.savefig('ricech4_effect_aogslupp.png')
plt.show()
