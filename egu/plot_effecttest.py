...
rects2 = plt.bar(0.2+index+bar_width*1, aycli, bar_width, yerr=sycli,
         ...
         label='Cli')
rects5 = plt.bar(0.2+index+bar_width*1, kayclinoi, bar_width, yerr=ksyclinoi,
         alpha=opacity,color='red',bottom=aycli,
         label='Cli X Irri')
rects0 = plt.bar(0.2+index+bar_width*2, ayirr, bar_width, yerr=syirr,
         alpha=opacity,color='yellow',
         label='Irri')
rects1 = plt.bar(0.2+index+bar_width*2, ayclinoi, bar_width, yerr=syclinoi,
...
plt.savefig('rice_effect_egutest.png')
plt.show()
