...
region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_irr_fert/output/ric_irr_fert.nc','r')
ma1 = region.variables['totalyield'][95:105,:,:]#1996-2005


dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_fert/output/ric_fert.nc','r')
ma1i = dat2.variables['totalyield'][95:105,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_irr/output/ric_irr.nc','r')
ma1f = dat3.variables['totalyield'][95:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_co2/output/ric_co2.nc','r')
ma1c = dat4.variables['totalyield'][95:105,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_cli/output/ric_cli.nc','r')
ma1cli = dat5.variables['totalyield'][95:105,:,:]


region=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_irr_fert/output/ric_irr_fert_ch4.nc','r')
ma2 = region.variables['ch4_flux'][95:105,:,:]#1996-2005


dat2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_fert/output/ric_fert_ch4.nc','r')
ma2i = dat2.variables['ch4_flux'][95:105,:,:]

dat3=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_irr/output/ric_irr_ch4.nc','r')
ma2f = dat3.variables['ch4_flux'][95:105,:,:]

dat4=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_co2/output/ric_co2_ch4.nc','r')
ma2c = dat4.variables['ch4_flux'][95:105,:,:]

dat5=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/aogs/experiments/ric_cli/output/ric_cli_ch4.nc','r')
ma2cli = dat5.variables['ch4_flux'][95:105,:,:]


isam1=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/luh2area_850_2015_corrcrop.nc','r')
meareaisam = isam1.variables['fric_tt'][1146:1156,:,:]#1980-2009
...
ma2=ma2*meareaisam*10000*16/12
ma2i=ma2i*meareaisam*10000*16/12
ma2f=ma2f*meareaisam*10000*16/12
ma2c=ma2c*meareaisam*10000*16/12
ma2cli=ma2cli*meareaisam*10000*16/12
...
plt.savefig('isamdiffbase_ric.jpg',bbox_inches='tight')
