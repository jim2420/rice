...
yanp=[251,453,6078,152,1663,5,331,1653,1166,744,1089,1651,55,126]
yanpp=[306,526,4110,42,767,0,150,2600,1328,636,2110,1560,159,252]
num=14
...
rects1 = plt.bar(index+0.18, allproisam, bar_width,
                 ...
                 color='blue',
                 label='ISAM')
rects2 = plt.bar(index +0.18+ bar_width*1,yanp , bar_width,
                 alpha=opacity,
                 color='r',
                 label='Yan et al. (2009)')
...
plt.tight_layout()
plt.savefig('ric2000ch4_count.png')
plt.show()
