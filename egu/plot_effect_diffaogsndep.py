...
rects412 = plt.bar(0.1+index+bar_width*8, tayn, bar_width, yerr=tsayn,hatch='..',
         alpha=opacity,color='m',
         label='Nitrogen deposition')

rects42 = plt.bar(0.1+index+bar_width*9, ayn, bar_width, yerr=sayn,
         alpha=opacity,color='m',
         label='Nitrogen deposition')

rects = plt.bar(0.1+index+bar_width*10, tsbase, bar_width, yerr=sbase,
...
plt.savefig('ricep_effect_aogsndep.png')
plt.show()
