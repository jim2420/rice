...
#         label='Climate')
rects22 = plt.bar(0.05+index+bar_width*3, aycli, bar_width, yerr=saycli,
         alpha=opacity,color='blue',
         label='Climate')
...
#         label='Irrigation')
rects0 = plt.bar(0.05+index+bar_width*5, ayirr, bar_width, yerr=sayirr,
         alpha=opacity,color='red',
         label='Irrigation')
...
rects4 = plt.bar(0.05+index+bar_width*7, ayf, bar_width, yerr=sayf,
         alpha=opacity,color='green',
         label='Nitrogen fertilizer')
...
rects42 = plt.bar(0.05+index+bar_width*9, aylu, bar_width, yerr=saylu,
         alpha=opacity,color='m',
         label='Land conversion')

#rects = plt.bar(0.05+index+bar_width*8, tsbase, bar_width, yerr=sbase,
...
leg=plt.legend(loc=2,ncol=6)
leg.get_frame().set_alpha(0.5)

plt.tight_layout()

plt.savefig('ricep_effect_aogsnolutest1.png')
plt.show()
