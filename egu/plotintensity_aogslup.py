...
yirr=(tbase1-tbase1_i)/tbase1*100
yf=(tbase1-tbase1_f)/tbase1*100
ycli=(tbase1-tbase1_cli)/tbase1*100
yc=(tbase1-tbase1_c)/tbase1*100
yn=(tbase1-tbase1_n)/tbase1*100
ylu=(tbase1-tbase1_lu)/tbase1*100

tyirr=(base1_i-base1)/tbase1*100
tyf=(base1_f-base1)/tbase1*100
tycli=(base1_cli-base1)/tbase1*100
tyc=(base1_c-base1)/tbase1*100
tyn=(base1_n-base1)/tbase1*100
tylu=(base1-base1_lu)/tbase1*100
...
rects412 = plt.bar(0.1+index+bar_width*8, taylu, bar_width, yerr=tsaylu,hatch='..',
         alpha=opacity,color='m',
         label='Land conversion')

rects42 = plt.bar(0.1+index+bar_width*9, aylu, bar_width, yerr=saylu,
         alpha=opacity,color='m',
         label='Land conversion')

#rects = plt.bar(0.05+index+bar_width*10, tsbase, bar_width, yerr=sbase,
#         alpha=opacity,color='gray',
#         label='Base')


plt.ylabel('Effect on CH4 intensity (%)',fontsize=18)
...
plt.savefig('riceintensity_effect_aogslupp.png')
plt.show()
