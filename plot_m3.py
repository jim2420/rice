...
isam=NetCDFFile('india/isamhiscru_rice_india.nc','r')
...
map.drawmapboundary()
ncvar_y=maskoceans(x,y,ryield)
cs1 = map.pcolormesh(x,y,ryield*m3newa,cmap=plt.cm.jet,vmin=0,vmax=200000)
plt.axis('off')
cbar = map.colorbar(cs1,location='right',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=18)
...
cs1 = map.pcolormesh(x,y,ryield*m3newa/gridarea/0.0001,cmap=plt.cm.jet,vmin=0,vmax=2)
plt.axis('off')
cbar = map.colorbar(cs1,location='right',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=18)


plt.savefig('isam_rice_avg_new.jpg',bbox_inches='tight')
