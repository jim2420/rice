...
def yieldout(year):
	...
	clm2=NetCDFFile('/scratch2/scratchdirs/tslin2/isam/rice_cheyenne/his_cru/egu_new/ric_irr_fert/output/ric_irr_fert.nc','r')
...
ncfile=NetCDFFile('isamhiscru_rice_eguclm.nc','w',format='NETCDF3_64BIT_OFFSET')
